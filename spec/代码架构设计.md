...
| 最近已完成的交付证据 | 当前轮次“退回重走后门禁不再无故反复失败”的主题验收、最终全量回归和整体验收已通过；更早轮次的交付状态只作为历史证据保留 | [退回重走后门禁不再无故反复失败_2_验收结果](../acceptance/退回重走后门禁不再无故反复失败_2_验收结果.md)、[对应测试结果](../qa/退回重走后门禁不再无故反复失败_2_测试结果.md)和本文第 9 节 |
...
- 功能到代码映射：完整
- 未处理差异：暂无
- 核对依据：主题验收事实见 acceptance/退回重走后门禁不再无故反复失败_2_验收结果.md（AC-01 至 AC-12 结论均为 passed）；主题验收实际使用的机器测试记录编号：RUN-20260902T093857+0000-a0b275af、RUN-20260902T093858+0000-2f8911b1、RUN-20260902T093858+0000-9d98b0ed、RUN-20260902T093858+0000-a2d77eab、RUN-20260902T093858+0000-deea9d6d、RUN-20260902T093859+0000-1ba62fe0、RUN-20260902T093859+0000-314f58d6、RUN-20260902T093859+0000-544c3b2a、RUN-20260902T093859+0000-57eeca7f、RUN-20260902T093900+0000-2994feb5、RUN-20260902T093900+0000-57349cc5、RUN-20260902T093900+0000-65f379fe、RUN-20260902T093900+0000-dd3d2205、RUN-20260902T093901+0000-424ec442、RUN-20260902T093901+0000-d3534368、RUN-20260902T093901+0000-fc798f73、RUN-20260902T093901+0000-fd86a80b、RUN-20260902T093902+0000-64a18ff8、RUN-20260902T093902+0000-88b09cb8、RUN-20260902T093902+0000-90c1fef4、RUN-20260902T093902+0000-ff6c50d4；最终全量回归执行事实：机器记录编号 REG-20260902T094129+0000-7d5e5020，命令 scripts/test_all.sh，退出码 0，532 项通过；整体验收确认：workflow gate overall_acceptance --confirmed 完成确认，全过程 journal 可复核；缺陷记录见 bug/缺陷_退回重走后门禁不再无故反复失败.md。本轮修改集中在第二道门检查顺序、退回后的引用回补、表模式判定、缺陷记录生成路径与锚点、占位内容判定和门禁日志字段，均落在既有分层内部，没有新增模块、没有改变分层关系，因此同步类型为架构未变化；对应事实已写入本文第 6.3、6.6、6.12 和 6.18 节。本轮在首次进入最终设计同步时由门禁发现两处本轮改动自身引入的缺陷（变化清单把未改动文件报成本阶段变化、回补重建已删除的结果文档），已退回代码实施修复并补 TC-20、TC-21 两项回归测试，修正后的行为同样写入上述章节。
