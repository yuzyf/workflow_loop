...
根据已经确认的产品设计，和用户形成一致的代码架构设计，并生成或修改 `spec/architecture_code_design.md`。
...
- 以已经确认的 `spec/product.md` 和全部 `spec/feature_*.md` 为产品依据。
...
仍有未决问题时继续一次讨论一个问题。只有用户明确确认共同设计后，才生成或修改 `spec/architecture_code_design.md`。
