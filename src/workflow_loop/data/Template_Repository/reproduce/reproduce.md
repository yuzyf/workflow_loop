...
启用缺陷工作记录表（程序类型 `bug_record`）时，只填表，由程序生成以下正式记录：

- 新轮次表版本 3：缺陷信息中分别填“根因说明”“根因位置”“根因证据”，叙述栏分别填“运行环境”“真实输入”。每栏只填事实，不重复标签；不再重复填写整栏根因证据。
- 冻结为版本 1 或 2 的旧轮次保留原栏目和已填内容。“根因”一格中分别写“根因说明：内容”“根因位置：内容”“根因证据：内容”；“真实复现条件”至少分别写“运行环境：内容”“真实输入：内容”，标签与内容同一行。
- “修复仍存在的不确定性”确无内容时整栏只填一条“暂无”；不能留空、混入占位词，也不能在根因、环境或输入等事实栏用“暂无”替代真实事实。
- “生成文档路径”“生成文档哈希”“缺陷文档哈希”是程序专用字段，已有值保持原样，新表保持空值，不由填写者维护。
...
“工作流编号”“验收主题”来自表固定栏目。没有工作记录表的旧文档模式下，固定字段标签和值必须写在同一行。
