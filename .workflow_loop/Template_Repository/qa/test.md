...
启用工作记录表时本文档由程序生成：固定字段中“工作流编号”“验收主题”来自表固定栏目，“自动化测试结果”“人工验收状态”“测试完成时间”由程序按测试执行记录和测试计划表的测试方式判定；“测试项结果”各 TC 小节来自测试结果表（test_result）“测试结果”行清单与叙述栏“执行说明”“人工验收交接”“未通过或阻塞”“结果说明”。AI 只填测试结果表的执行结论、机器记录编号和实际结果说明等栏位，机器事实字段由程序从执行记录写入，不手抄。
...
“机器记录编号”“工作目录”“测试入口”“执行命令”“超时（秒）”“运行环境”“开始时间”“结束时间”“时长（秒）”“退出码”“输出摘要”“输出哈希”“输出字节数”“报告适配器”“报告哈希”“报告字节数”“精确匹配测试入口”“实际执行数”“跳过数”“失败数”“错误数”“产品代码哈希”和“测试代码哈希”都是程序执行时记录的机器事实，由程序在生成结果文档时从 State Snapshot（状态快照）当前有效的执行记录逐字段写入；AI 不手抄、不改写。
