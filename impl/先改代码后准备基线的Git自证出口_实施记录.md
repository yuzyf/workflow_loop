...
| 下游 | [先改代码后准备基线的Git自证出口 测试计划](../qa/先改代码后准备基线的Git自证出口_测试计划.md) | 代码结果确认后，在测试验证开始时确认范围和通过标准 |
| 下游 | [先改代码后准备基线的Git自证出口 测试结果](../qa/先改代码后准备基线的Git自证出口_测试结果.md) | 同一测试验证阶段连续完成测试代码、登记、执行和结果 |
| 下游 | [先改代码后准备基线的Git自证出口 验收结果](../acceptance/先改代码后准备基线的Git自证出口_验收结果.md) | 正式测试后执行主题验收 |
